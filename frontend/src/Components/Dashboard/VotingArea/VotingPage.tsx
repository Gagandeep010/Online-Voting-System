...
//           const meta = metadata.find(m => m.name === candidate.name);
//           fetched.push({
//             name: candidate.name,
//             age: meta?.age || '—',
//             party: meta?.party || '—',
...
//       const candidateIndex = candidates.findIndex(c => c.name === selectedCandidate);
//       if (candidateIndex === -1) {
...
//       await contract.methods.castVote(aadhaarHash, candidateIndex).send({ from: accounts[0] });
...
//             <button className="cancel-btn" onClick={() => navigate("/switch")}>🔄 Switch Voter</button>
//           </div>
//         ) : (
...
//           {candidates.length === 0 ? (
//             <p>No on-chain candidates found.</p>
//           ) : (
//             candidates.map((candidate, index) => (
//               <div key={index} className="bottom-card" onClick={() => handleVoteClick(candidate.name)}>
//                 <div className="card-name">{candidate.name}</div>
//                 <div className="card-desc">
//                   <p>🧓 Age: {candidate.age}</p>
//                   <p>🏛️ Party: {candidate.party}</p>
